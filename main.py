...
success_flags = []
success_ratios = []
# methods = ['proposed', 'EFT']
# methods = ['proposed', 'best', 'worst', 'EFT']
            ...
            for cluster_total_core in cluster_total_cores:
                ...
                for m in range(40, 41, 20):
                    for n in range(dag_num):
                        # print(n)
                        print("\rlight_false: evaluated "+str(method)+" taskset : "+str(m)+" DAG, cluster_num="+str(cluster_num)+", total_core="+str(cluster_total_core)+", task num="+str(n)+ "  ",end="")
                        # n=3
                    ...
                    print("total_intra_comm_ave = "+str(sum(intra_cc_cost) / dag_num))
