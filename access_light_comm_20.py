...
for method_name in methods:
    #クラスタ数とトータルコア数を固定
    with open(f'result/access_light_comm_{method_name}_20.txt', 'w') as f:
            ...
            for cluster_total_core in cluster_total_cores:
                ...
                for m in range(40, 121, 20):
                    for n in range(dag_num):
                        ...
                        # cluster_core_num = 16
                        # deadline_ratio = 0.8
                        simulator = Simulator(dag, cluster_num, cluster_core_num, cc_time_ratio, method_name, seed=seed)
