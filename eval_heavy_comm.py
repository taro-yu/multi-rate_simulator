...
for method_name in methods:
    #クラスタ数とトータルコア数を固定
    with open(f'result/comm_heavy_{method_name}.txt', 'w') as f:
            ...
            for cluster_total_core in cluster_total_cores:
                ...
                for heavy_task_num in range(2, 7, 1):
                    for n in range(dag_num):
                        ...
                        # cluster_core_num = 16
                        # deadline_ratio = 0.8
                        simulator = Simulator(dag, cluster_num, cluster_core_num, cc_time_ratio, heavy_task_num=heavy_task_num, method_name=method_name)
