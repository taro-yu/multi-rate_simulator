...
for method_name in methods:
    #クラスタ数とトータルコア数を固定
    with open(f'result/access_respo_heavy_{method_name}_20.txt', 'w') as f:
    # with open(f'result/access_respo_heavy_{method_name}_not_20.txt', 'w') as f:
            ...
            for cluster_total_core in cluster_total_cores:
                ...
                for cluster_comm_ratio in range(1, 51, 1):
                    ...
                    for n in range(dag_num):
                        ...
                        # cluster_core_num = 16
                        # deadline_ratio = 0.8
                        simulator = Simulator(dag, cluster_num, cluster_core_num, cluster_comm_ratio=cluster_comm_ratio, method_name=method_name, heavy_task_num=5, seed=seed)
                ...
                # f.write(f"respo_{method_name}_heavy_{cluster_num}_{cluster_core_num}_not_respo_ave={ave_list_respo}\n\n")
